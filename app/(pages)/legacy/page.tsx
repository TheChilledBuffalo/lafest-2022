    ...
    return (
        <div className={`${Helvetica.className} w-full mt-5 flex flex-col justify-center font-semibold text-center`}>
            <div>
                ...
                The idea gathered momentum among students. But somebody had to get the green signal from the Principal Fr. Mani Manimala.<br />
                One afternoon, as the school bell rang, the teacher surrounded by students egging her on told Fr. Mani,<br />
                'The students have been saying that they want to organise a festival for schools in the city.' The Principal, full of energy<br /> but looking stern as ever, replied,<br />
                'If you are ready to take full responsibility, go ahead.'<br />
                The students who overheard this were ecstatic. <br />
                The teacher who had bravely conveyed the proposal could not back out.<b /> Her students would ensure that, year after year.<br />
            </div>
            ...
            <div className={"h-full flex flex-col items-center mb-10 gap-y-10"}>
                <LegacyCard
                    ...
                    description={
                        <div>
                            Relive the day.<br />
                            Relive the art.<br />
                            Relive awesomeness.<br />
                            Relive the art of waging wars on stage.<br />
                            Relive LA Fest 2010, where there was life in every art.<br />
                        </div>
                    }
                ...
                <LegacyCard
                    ...
                    description={
                        <div>
                            ...
                            LA Fest the first ever inter-school fest still holds an enviable position even in the face of present day stiff competition.
                        </div>
                    }
                ...
                <LegacyCard
                    ...
                    description={
                        <div>
                            An idea to create something new...<br />
                            Something that would change the face of humanity in Trivandrum… <br />
                            An idea to bring Life and Arts together in an ethereal melting pot of talent…<br />
                        </div>
                    }
                    winner={"At the end of the day, Holy Angels ISC emerges as the overall champions."}
                />
                <LegacyCard
                    ...
                    description={
                        <div>
                            The meticulous craftsmanship of 17 long years.<br />
                            A fusillade of sheer ingenuity that tugs at your heartstrings and astounds with its aesthetic appeal.<br />
                ...
                <LegacyCard
                    ...
                    description={
                        <div>
                            Empires aren't built in a day but legacy is made in one.<br />
                            A legacy of 18 has come to pass.<br />
                            Now the stars are realigning.<br />
                ...
                <LegacyCard
                    ...
                    description={
                        <div>
                            As the heavens stand still and the gates to Arcadia open...<br />
                            Experience the twentieth chapter of the eternal saga which celebrates the art of life.
                        </div>
                    }
                ...
                <LegacyCard
                    ...
                    tagline={
                        <div>
                            2 Decades Of Legacy<br />
                            1 Day For Legends
                        </div>
                    }
                    description={
                        <div>
                            The prophecy written by the ancients two decades ago has come to pass.<br />
                            The wheels of the celestial machinery have ever since been spinning…churning out champions.<br />
