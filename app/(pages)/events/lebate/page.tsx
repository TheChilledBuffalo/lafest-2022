...
export default function Harmony() {
  ...
  return (
    <div className={"absolute top-0 h-full w-full bg-[#4e93e8]"}>
      <section
        className={
          "relative flex h-screen w-full flex-col items-center justify-center before:absolute before:bottom-0 before:z-[1000] before:h-40 before:w-full before:bg-gradient-to-t before:from-[#4e93e8] before:to-transparent"
        }
      >
        <Image
